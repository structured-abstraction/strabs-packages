{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/media/lakin/data/work-repos/strabs-packages";
  project_input_ref = "path:/media/lakin/data/work-repos/strabs-packages";
  devenv_dotfile = "/media/lakin/data/work-repos/strabs-packages/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-f3ae26b";
  ...
  hostname = "gratch";
  username = "lakin";
  git_root = "/media/lakin/data/work-repos/strabs-packages";
  secretspec = null;
};
    in
    {
